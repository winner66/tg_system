...
$(function () {
    $("#jqGrid").jqGrid({
        ...
        loadComplete: function (data) {
            //为所有数据行，具体取决于reader配置的root或者服务器返回的内容
            roleList = data.page.list;
        }
    });
});
...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function () {
            ...
            var subsidiary = $("#subsidiary").find("option:selected").attr("index");
            vm.role.deptIdList = deptIdList;
            vm.role.subsidiary = subsidiary;
        ...
        getMenuTree: function (roleId) {
            ...
            $.get(baseURL + "sys/menu/list", function (r) {
                ...
                //非超级管理员无系统管理权限
                var node = menu_ztree.getNodeByParam("menuId", 40);
                menu_ztree.removeChildNodes(node);
                menu_ztree.removeNode(node);
                //展开所有节点
