var fileTypeArr = ['jpg', 'jpeg', 'png'];//文件格式限制
var fileSizeControl = 5;//文件大小控制 单位: MB
...
if (new FileReader == 'undefined') {
    layer.msg("你的浏览器不支持FileReader！，请更换浏览器");
}

/**
 * 上传图片触发方法
 * @param flags 分类
 * @param type 该分类下对应图片标记
 * @param obj this 当前对象
 */
function upFiles(flags, type, obj) {
...
function readAsDataURL(namenum) {
    ...
    console.log(fileObj[0].files.length);
