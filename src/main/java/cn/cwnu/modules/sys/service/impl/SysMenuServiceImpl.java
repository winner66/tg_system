...
public class SysMenuServiceImpl implements SysMenuService {
	 ...
	 * 获取所有菜单列表
	 */
	private List<SysMenuEntity> getAllMenuList(List<Long> menuIdList, Integer userId){
		//查询根菜单列表
	 ...
	 * 递归
	 */
	private List<SysMenuEntity> getMenuTreeList(List<SysMenuEntity> menuList, List<Long> menuIdList, Integer userId){
		List<SysMenuEntity> subMenuList = new ArrayList<SysMenuEntity>();
		SysMenuEntity systemManager= null;
		for(SysMenuEntity entity : menuList){
			if(entity.getName().equals(Constant.SYSTEMMANAGER))
				systemManager = entity;
