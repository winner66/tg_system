...
public class DataFilterAspect {
    ...
    @Pointcut("@annotation(cn.cwnu.common.annotation.DataFilter)")
    ...
    public void dataFilter(JoinPoint point) {
        ...
        if (params != null && params instanceof Map) {
            ...
            if (user.getId() != Constant.SUPER_ADMIN) {
                Map map = (Map) params;
                map.put("filterSql", getDeptFilterSQL(user, point));
            }
     ...
     * 获取数据过滤的SQL
     */
    private String getDeptFilterSQL(SysUserEntity user, JoinPoint point) {
